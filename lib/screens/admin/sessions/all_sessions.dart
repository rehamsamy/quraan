...
class _AllSessionsState extends State<AllSessions> {
  ...
  getAllSessions() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print("list of student are ${sessionList.length}");
        print("list of student are ${sessionList}");
      }
  ...
  removeSession(id) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    try {
      var response = await Dio().delete("${AppConstance.api_url}/sessions/${id}",
          options: Options(headers: {
            'Authorization':
            'Bearer ${json.decode(prefs.getString("tokenAccess")!)}',
          }));
                ...
                Row(
                  ...
                  children: [
                    TextButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => AddSessionScreen(),));
                    }, child: Text("إضافة جلسة جديدة",style: TextStyle(color: Colors.white),)),
                  ],
                ),
                Container(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: Text(
                                  sessionList[index].numberOfStudents.toString(),
                                  softWrap: true,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                ))
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: Text(
                                  sessionList[index].teacher!.name.toString(),
                                  softWrap: true,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                ))
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: Text(
                                  sessionList[index].status == "1" ? "مفعل" : "غير مفعل",
                                  softWrap: true,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                ))
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateSessionScreen(sessionModel: sessionList[index]),));
                                },
                                child: Text(
                                  "تعديل",
                            ...
                            TextButton(
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => SessionDetailsScreen(sessionModel: sessionList[index]),));
                                },
                                child: Text(
                                  "التفاصيل",
